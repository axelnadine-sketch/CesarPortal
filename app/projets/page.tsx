...
export default async function ProjectsPage() {
  ...
  return (
    <main className="pb-20 pt-8 text-neutral-100">
      <Container>
        <section className="rounded-[2.5rem] border border-[#238636]/45 bg-white/[0.045] px-6 py-10 shadow-[0_20px_80px_rgba(0,0,0,0.28)] md:px-10 md:py-14">
          ...
          {projects.length ? (
            <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
              {projects.map((project) => (
                <article
                  className="rounded-[2rem] border border-[#238636]/45 bg-white/[0.045] p-6"
                  key={project.id}
                >
                  ...
                  {project.nextAction ? (
                    <div className="mt-5 rounded-[1.5rem] border border-[#238636]/45 bg-black/15 p-4">
            ...
            <div className="rounded-[2rem] border border-dashed border-[#238636]/45 bg-white/[0.03] p-8 text-center text-sm text-white/60">
